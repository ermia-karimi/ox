...
// const startBtn1 = document.getElementById('startBtn2');
// const statusText = document.getElementById('circle2');

// const inhaleTime = 5000; // دم = ۴ ثانیه
// const exhaleTime = 5000; // بازدم = ۶ ثانیه
...
const circle1 = document.getElementById('circle2');
const startBtn1 = document.getElementById('startBtn6');
const statusText = document.getElementById('circle2');

const inhaleTime = 5000; // دم
const exhaleTime = 5000; // بازدم
const totalCycles = 6;   // تعداد تکرار
...
function start() {
    ...
    function runCycle() {
        ...
        // --- پایان چرخه و رفتن به چرخه بعدی ---
...
button.addEventListener('click', () => {
    ...
    const clicks = JSON.parse(localStorage.getItem('clickData6')) || {};
    clicks[today] = (clicks[today] || 0) + 1; // فقط یک واحد اضافه شود
    localStorage.setItem('clickData6', JSON.stringify(clicks));
});
